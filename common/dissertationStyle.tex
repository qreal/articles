...
% Объявляем дополнительную библиографию для ВАКовских статей, надо в автореферате
\newcites{vak}{В изданиях из перечня российских рецензируемых научных} 
...
\bibliographystylevak{ugost2003s}  % Определяем для неё стиль

%\newcites{scopus}{В изданиях, индексируемых в реферативных базах Scopus и Web Of Science}  % Объявляем дополнительную библиографию для ВАКовских статей, надо в автореферате
%\bibliographystylescopus{ugost2003s}  % Определяем для неё стиль
