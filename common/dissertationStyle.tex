...
%%% Библиография %%%
\makeatletter
\bibliographystyle{ugost2003sdisser}	% Оформляем библиографию в соответствии с ГОСТ 7.1-2003
...
% "Обтекаемые" картинки (для автореферата, где каждый квадратный сантиметр бумаги на счету).
\usepackage{wrapfig}