...
This section discusses the subsystem handling TRIK Studio interaction with robots over different protocols. It is one of the lowest abstraction layers shown on the Fig.~\ref{image:commonTSArch}. Its API provides the following operations: 
